...
const lectureImageMap: Record<string, string> = {
    ...
    // --- CORRECTED SPECIAL STAINS ---

    // [FIXED] AFB stain highlighting slender red bacilli in tuberculosis.
    lecture_tb_afb_image:
        'https://pathology.or.jp/corepicturesEN/05/c11/04.jpg', // Sourced from Google Search
    // [FIXED] Histoplasmosis with GMS-positive yeast forms.
    lecture_histoplasma_gms_image:
        'https://storage.googleapis.com/granuloma-lecture-bucket/granulomas/histoplasmosis/GMS/histoplasmosis_histoplasmosis_06.jpg', // Sourced from Manifest
    // [FIXED] Blastomycosis with broad-based budding demonstrated on PAS. (Orphaned key)
    lecture_blastomycosis_pas_image:
        'https://storage.googleapis.com/granuloma-lecture-bucket/granulomas/blastomycosis/PAS/blastomycosis_blastomycosis_35.jpg', // Sourced from Manifest
    // [FIXED] Talc granulomatosis with birefringent material. (Orphaned key)
    lecture_talc_image:
        'https://webpath.med.utah.edu/INFLHTML/INFL058.jpg', // Sourced from Google Search
    // [FIXED] Coccidioidomycosis with large spherules. (Orphaned key)
    ...
    // [FIXED] Cryptococcosis with mucicarmine-positive capsules. (Orphaned key)
    lecture_crypto_series_image:
        'https://storage.googleapis.com/granuloma-lecture-bucket/granulomas/cryptococcosis/Mucicarmine/cryptococcosis_cryptococcosis_36.jpg', // Sourced from Manifest
};

// Secondary CDN images to use if primaries fail.
const lectureFallbackImageMap: Record<string, string> = {
    // --- Fallbacks for Core H&E ---
    lecture_tb_image:
    ...
    // --- CORRECTED FALLBACKS for Special Stains ---
    lecture_tb_afb_image:
        'https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6723956/bin/jcm-08-01180-g002.jpg', // Sourced from Google Search
    lecture_histoplasma_gms_image:
        'https://storage.googleapis.com/granuloma-lecture-bucket/granulomas/histoplasmosis/GMS/histoplasmosis_histoplasmosis_35.jpg', // Sourced from Manifest
    lecture_blastomycosis_pas_image:
        'https://storage.googleapis.com/granuloma-lecture-bucket/granulomas/blastomycosis/PAS/blastomycosis_blastomycosis_55.jpg', // Sourced from Manifest
    lecture_cocci_series_image:
    ...
    lecture_crypto_series_image:
        'https://storage.googleapis.com/granuloma-lecture-bucket/granulomas/cryptococcosis/Mucicarmine/cryptococcosis_cryptococcosis_02.jpg', // Sourced from Manifest
    lecture_talc_image:
        'https://www.ncbi.nlm.nih.gov/pmc/articles/PMC2491654/bin/1477-7517-5-17-4.jpg', // Sourced from Google Search
};
