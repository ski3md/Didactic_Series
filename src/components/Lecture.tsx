...
const layoutByDevice: Record<DeviceType, LayoutTokens> = {
    mobile: {
        ...
        typeScale: {
            heading: 'text-[clamp(2.2rem,6vw,2.6rem)]',
            subtitle: 'text-[clamp(1.1rem,3.3vw,1.35rem)]',
            sectionHeading: 'text-[clamp(1.9rem,5.5vw,2.3rem)]',
            body: 'text-[clamp(0.95rem,2.8vw,1.15rem)] leading-relaxed',
            smallBody: 'text-[clamp(0.85rem,2.4vw,1.05rem)] leading-relaxed',
        },
        bullet: {
            grid: 'grid-cols-1',
            gap: 'gap-4',
    ...
    tablet: {
        ...
        typeScale: {
            heading: 'text-[clamp(2.4rem,4vw,2.9rem)]',
            subtitle: 'text-[clamp(1.25rem,2.2vw,1.5rem)]',
            sectionHeading: 'text-[clamp(2.1rem,3.5vw,2.6rem)]',
            body: 'text-[clamp(1.05rem,2vw,1.25rem)] leading-relaxed',
            smallBody: 'text-[clamp(0.95rem,1.8vw,1.15rem)] leading-relaxed',
        },
        bullet: {
    ...
    desktop: {
        ...
        typeScale: {
            heading: 'text-[clamp(2.6rem,3vw,3.4rem)]',
            subtitle: 'text-[clamp(1.4rem,1.8vw,1.8rem)]',
            sectionHeading: 'text-[clamp(2.3rem,2.8vw,2.8rem)]',
            body: 'text-[clamp(1.1rem,1.6vw,1.35rem)] leading-relaxed',
            smallBody: 'text-[clamp(1rem,1.4vw,1.25rem)] leading-relaxed',
        },
        bullet: {
            grid: 'grid-cols-1 md:grid-cols-2',
            gap: 'gap-8',
