            ...
            <div className="rounded-lg border border-slate-200 bg-white">
              <div className="border-b border-slate-200 px-4 py-3">
                ...
                <p className="mt-2 text-sm leading-6 text-slate-600">
                  The active build-out now covers nearly the full P0 AP queue across core AP scaffolds, cardiovascular/autopsy, endocrine, dermatopathology, GI, breast, male reproductive, pediatric/perinatal, and small-domain batches with the same five-gate promotion model.
                </p>
