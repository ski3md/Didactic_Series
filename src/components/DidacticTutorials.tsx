            ...
            <Card>
              ...
              {activeTutorial.cpGovernance && (
                <div className="mb-5 space-y-4">
                    ...
                    <div className="mt-3 grid gap-4 lg:grid-cols-[minmax(0,1.15fr)_minmax(0,0.85fr)]">
                      <div>
                        ...
                        <div className="mt-3 flex flex-wrap gap-2">
                          ...
                          <span className="rounded-full bg-white px-3 py-1 text-xs font-medium text-slate-700">
                            Level {activeTutorial.cpGovernance.abpathPrimaryLevel}
                          </span>
                  ...
                  {activeTutorial.sourceTruth && (
                    <div className="rounded-2xl border border-emerald-200 bg-emerald-50/70 p-5">
                      <div className="text-xs font-semibold uppercase tracking-wide text-emerald-700">
                        Reviewed source decision
                      </div>
                      <div className="mt-2 text-xs font-medium text-emerald-800">{activeTutorial.sourceTruth.statusLabel}</div>
                      <p className="mt-2 text-sm leading-6 text-emerald-950">
                        {normalizePublicStudyPath(activeTutorial.sourceTruth.sourceDecision)}
                      </p>
                      <div className="mt-4 rounded-xl border border-emerald-200 bg-white p-4">
                        <div className="text-xs font-semibold uppercase tracking-wide text-slate-500">Review rule</div>
                ...
                <div className="mb-5 rounded-2xl border border-slate-200 bg-slate-50 p-5">
                  ...
                  {activeTutorial.sourceTruth && (
                    <div className="mt-4 rounded-2xl border border-emerald-200 bg-white p-4">
                      ...
                      <div className="mt-3 text-xs font-semibold uppercase tracking-wide text-slate-500">Review rule</div>
                      <p className="mt-2 text-sm leading-6 text-slate-700">{activeTutorial.sourceTruth.reviewRule}</p>
                      <p className="mt-2 text-xs font-medium text-slate-500">Owner: {activeTutorial.sourceTruth.reviewer}</p>
                    </div>
                  )}
