...
const DevelopmentPhase: React.FC = () => {
  ...
  return (
    <div className="animate-fade-in">
      ...
      <Card>
        <h2 className="text-2xl font-semibold font-serif text-slate-900 mb-4">Comparative Job Aid: Sarcoidosis vs. Tuberculosis</h2>
        <p className="text-slate-700 mb-6">This table highlights key distinguishing features between two common entities. Use it as a quick reference at the microscope.</p>
      ...
      <Card>
        <h2 className="text-2xl font-semibold font-serif text-slate-900 mb-4">Interactive Case Study: "The Bird Fancier's Cough"</h2>
        
        <div className="space-y-6">
            <div>
                <h3 className="font-bold text-lg font-serif text-slate-900 mb-2">Part 1: Clinical & Radiologic Data</h3>
                <p className="text-slate-700">{caseText.clinical}</p>
            </div>
             <div>
             ...
             <div>
                <h3 className="font-bold text-lg font-serif text-slate-900 mb-2">Part 3: The Diagnostic Task</h3>
                <p className="text-slate-700 mb-4">Given the integrated clinical, radiologic, and histologic findings, construct a ranked differential diagnosis. Justify your top two choices.</p>
                <button 
                    onClick={() => setShowAnswer(!showAnswer)}
                    className="bg-sky-600 text-white font-medium py-2 px-5 rounded-lg hover:bg-sky-700 focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-sky-500 transition-colors shadow-sm">
