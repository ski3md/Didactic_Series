# AGENTS.md — Didactic Series Operating Contract

Before any Codex or LLM action in this repo, obey:
...
If the repo is dirty, start in OBSERVE mode.

## Semantic dirtiness synthesis contract

Before any cleanup planning or mutation in this repo, obey:
...
Before any corpus inventory, indexing, mapping, or promotion work in this repo, obey:
