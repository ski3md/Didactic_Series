...
const SubSectionHeader: React.FC<{ icon: React.ReactNode; title: string }> = ({ icon, title }) => (
    <div className="flex items-center mb-4">
        ...
        <h2 className="text-2xl font-semibold font-serif text-slate-800">{title}</h2>
    </div>
);
            ...
            <div key={index}>
              ...
              <div className="space-y-3">
                {q.options.map(option => {
                  ...
                  let optionClass = 'bg-white border-slate-300 hover:bg-slate-50 hover:border-slate-400 focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-primary-500';
                  if (isAnswered) {
                      if (isCorrect) {
                  ...
                  return (
                    ...
                    >
                      ...
                      {isAnswered && isCorrect && isSelected && <CheckCircleIcon className="h-5 w-5 text-green-600" />}
