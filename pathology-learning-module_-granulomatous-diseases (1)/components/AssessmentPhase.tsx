      ...
      <Card>
        ...
        <div className="mt-8 border-t border-slate-200 pt-6 text-center">
            <button 
                ...
                className="bg-primary-600 text-white font-semibold py-2.5 px-8 rounded-lg hover:bg-primary-700 transition-colors disabled:bg-slate-400 disabled:cursor-not-allowed focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-primary-500 shadow-sm">
                Submit Answer
            </button>
        </div>
